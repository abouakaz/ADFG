...
public class ChannelCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return AdfgBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateChannel_4005(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Channel newElement = AdfgFactory.eINSTANCE.createChannel();
		getContainer().getConnections().add(newElement);
		newElement.setSource(getSource());
		newElement.setTarget(getTarget());
		ElementInitializers.getInstance().init_Channel_4005(newElement);
