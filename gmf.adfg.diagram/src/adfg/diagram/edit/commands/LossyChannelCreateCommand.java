 ...
 * @generated
 */
public class LossyChannelCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LossyChannelCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return AdfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateLossyChannel_4007(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		LossyChannel newElement = AdfgFactory.eINSTANCE.createLossyChannel();
		getContainer().getConnections().add(newElement);
		newElement.setSource(getSource());
		newElement.setTarget(getTarget());
		ElementInitializers.getInstance().init_LossyChannel_4007(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(LossyChannel newElement,
