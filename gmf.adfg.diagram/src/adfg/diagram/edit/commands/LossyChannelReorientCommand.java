 ...
 * @generated
 */
public class LossyChannelReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public LossyChannelReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof LossyChannel) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return AdfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLossyChannel_4007(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Graph container = (Graph) getLink().eContainer();
		return AdfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLossyChannel_4007(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected LossyChannel getLink() {
		return (LossyChannel) getElementToEdit();
	}
