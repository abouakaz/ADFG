 ...
 * @generated
 */
public class AffineRelationNEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AdfgVisualIDRegistry
						.getType(adfg.diagram.edit.parts.AffineRelationNEditPart.VISUAL_ID),
				new Point(-2, -2));
	}
	 ...
	 * @generated
	 */
	public AffineRelationNEditPart(View view) {
		super(view);
	}
