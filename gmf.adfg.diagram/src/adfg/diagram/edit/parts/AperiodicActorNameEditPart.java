...
import adfg.diagram.edit.policies.AdfgTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AperiodicActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AperiodicActorNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new AdfgTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return AdfgElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AdfgParserProvider
					.getParser(
							AdfgElementTypes.AperiodicActor_3014,
							getParserElement(),
							AdfgVisualIDRegistry
									.getType(adfg.diagram.edit.parts.AperiodicActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					AdfgEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
