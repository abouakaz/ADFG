 ...
 * @generated
 */
public class ChannelIdEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AdfgVisualIDRegistry
						.getType(adfg.diagram.edit.parts.ChannelIdEditPart.VISUAL_ID),
				new Point(4, 4));
	}
	 ...
	 * @generated
	 */
	public ChannelIdEditPart(View view) {
		super(view);
	}
