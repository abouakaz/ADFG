 ...
 * @generated
 */
public class ChannelInitialSizeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AdfgVisualIDRegistry
						.getType(adfg.diagram.edit.parts.ChannelInitialSizeEditPart.VISUAL_ID),
				new Point(-2, -2));
	}
	 ...
	 * @generated
	 */
	public ChannelInitialSizeEditPart(View view) {
		super(view);
	}
