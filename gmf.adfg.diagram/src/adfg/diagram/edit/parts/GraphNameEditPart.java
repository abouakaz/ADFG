 ...
 * @generated
 */
public class GraphNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GraphNameEditPart(View view) {
		super(view);
	}
			...
			parser = AdfgParserProvider
					.getParser(
							...
							AdfgVisualIDRegistry
									.getType(adfg.diagram.edit.parts.GraphNameEditPart.VISUAL_ID));
		}
		return parser;
	}
