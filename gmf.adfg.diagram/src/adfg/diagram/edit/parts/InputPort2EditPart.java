...
import adfg.diagram.edit.policies.InputPort2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPort2EditPart extends BorderedBorderItemEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof InputPortName2EditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AdfgVisualIDRegistry
				.getType(InputPortName2EditPart.VISUAL_ID));
	}
