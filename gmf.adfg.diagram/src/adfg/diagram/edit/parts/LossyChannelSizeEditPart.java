 ...
 * @generated
 */
public class LossyChannelSizeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AdfgVisualIDRegistry
						.getType(adfg.diagram.edit.parts.LossyChannelSizeEditPart.VISUAL_ID),
				new Point(-2, -2));
	}
	 ...
	 * @generated
	 */
	public LossyChannelSizeEditPart(View view) {
		super(view);
	}
