...
import adfg.diagram.edit.policies.OutputPortItemSemanticEditPolicy;
...
public class OutputPortEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public class OutputPortFigure extends Ellipse {
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 92, 64, 51);
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		if (notification.getNotifier() instanceof OutputPort) {
			if (notification.getFeature() instanceof EAttribute) {
				OutputPort port = (OutputPort) notification.getNotifier();
				if (port.getConnection() instanceof Channel) {
					...
					if ("sequence".equals(refName)) {
						channel.getOwner().getDataflow()
								.updateModelChannel(channel, "produce");
