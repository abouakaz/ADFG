 ...
 * @generated
 */
public class OutputPortName2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				AdfgVisualIDRegistry
						.getType(adfg.diagram.edit.parts.OutputPortName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public OutputPortName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AdfgParserProvider
					.getParser(
							AdfgElementTypes.OutputPort_3016,
							getParserElement(),
							AdfgVisualIDRegistry
									.getType(adfg.diagram.edit.parts.OutputPortName2EditPart.VISUAL_ID));
		}
