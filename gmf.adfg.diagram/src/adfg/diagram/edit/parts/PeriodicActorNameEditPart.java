 ...
 * @generated
 */
public class PeriodicActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PeriodicActorNameEditPart(View view) {
		super(view);
	}
			...
			parser = AdfgParserProvider
					.getParser(
							...
							AdfgVisualIDRegistry
									.getType(adfg.diagram.edit.parts.PeriodicActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
