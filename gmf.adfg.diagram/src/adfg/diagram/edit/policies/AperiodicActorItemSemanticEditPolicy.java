...
import adfg.diagram.edit.commands.InputPort2CreateCommand;
import adfg.diagram.edit.commands.OutputPort2CreateCommand;
 ...
 * @generated
 */
public class AperiodicActorItemSemanticEditPolicy extends
		AdfgBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AperiodicActorItemSemanticEditPolicy() {
		super(AdfgElementTypes.AperiodicActor_3014);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (AdfgElementTypes.InputPort_3015 == req.getElementType()) {
			return getGEFWrapper(new InputPort2CreateCommand(req));
		}
		if (AdfgElementTypes.OutputPort_3016 == req.getElementType()) {
