...
import adfg.diagram.edit.commands.GraphCreateCommand;
...
public class ApplicationItemSemanticEditPolicy extends
	...
	public ApplicationItemSemanticEditPolicy() {
		super(AdfgElementTypes.Application_1000);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (AdfgElementTypes.Graph_2001 == req.getElementType()) {
			return getGEFWrapper(new GraphCreateCommand(req));
		}
