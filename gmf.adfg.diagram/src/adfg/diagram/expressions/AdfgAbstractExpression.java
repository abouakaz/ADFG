 ...
 * @generated
 */
public abstract class AdfgAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = AdfgDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AdfgAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
