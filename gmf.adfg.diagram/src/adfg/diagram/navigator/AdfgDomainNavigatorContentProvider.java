 ...
 * @generated
 */
public class AdfgDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AdfgDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof AdfgDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((AdfgDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new AdfgDomainNavigatorItem((EObject) objects[i],
