 ...
 * @generated
 */
public class LossyChannelLabelExpressionLabelParser1 extends
		ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public LossyChannelLabelExpressionLabelParser1() {
	}
	...
	protected String getExpressionBody() {
		return AdfgOCLFactory.getExpression(5,
				AdfgPackage.eINSTANCE.getLossyChannel(), null).body();
	}
