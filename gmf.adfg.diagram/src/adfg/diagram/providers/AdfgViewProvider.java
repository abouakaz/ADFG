 ...
 * @generated
 */
public class AdfgViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = AdfgVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = AdfgVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!AdfgElementTypes.isKnownElementType(elementType)
		...
		return GraphEditPart.VISUAL_ID == visualID
				|| PeriodicActorEditPart.VISUAL_ID == visualID
				|| InputPortEditPart.VISUAL_ID == visualID
				|| OutputPortEditPart.VISUAL_ID == visualID
				|| AperiodicActorEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = AdfgVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != AdfgVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = AdfgVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = AdfgVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case GraphEditPart.VISUAL_ID:
			return createGraph_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case PeriodicActorEditPart.VISUAL_ID:
			return createPeriodicActor_3011(domainElement, containerView,
					index, persisted, preferencesHint);
		case InputPortEditPart.VISUAL_ID:
			return createInputPort_3012(domainElement, containerView, index,
					persisted, preferencesHint);
		case OutputPortEditPart.VISUAL_ID:
			return createOutputPort_3013(domainElement, containerView, index,
					persisted, preferencesHint);
		case AperiodicActorEditPart.VISUAL_ID:
			return createAperiodicActor_3014(domainElement, containerView,
					index, persisted, preferencesHint);
		case InputPort2EditPart.VISUAL_ID:
			return createInputPort_3015(domainElement, containerView, index,
					persisted, preferencesHint);
		case OutputPort2EditPart.VISUAL_ID:
			return createOutputPort_3016(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (AdfgVisualIDRegistry.getVisualID(elementTypeHint)) {
		case AffineRelationEditPart.VISUAL_ID:
			return createAffineRelation_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ChannelEditPart.VISUAL_ID:
			return createChannel_4005(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case GraphConnectionEditPart.VISUAL_ID:
			return createGraphConnection_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case LossyChannelEditPart.VISUAL_ID:
			return createLossyChannel_4007(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createGraph_2001(EObject domainElement, View containerView,
		...
		node.setType(AdfgVisualIDRegistry.getType(GraphEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createPeriodicActor_3011(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AdfgVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createInputPort_3012(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AdfgVisualIDRegistry.getType(InputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createOutputPort_3013(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AdfgVisualIDRegistry.getType(OutputPortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createAperiodicActor_3014(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createInputPort_3015(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(AdfgVisualIDRegistry.getType(InputPort2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createOutputPort_3016(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5013 = createLabel(node,
				AdfgVisualIDRegistry.getType(OutputPortName2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createAffineRelation_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(AdfgVisualIDRegistry
		...
		Node label6001 = createLabel(edge,
				AdfgVisualIDRegistry.getType(AffineRelationNEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createChannel_4005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(AdfgVisualIDRegistry.getType(ChannelEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		Node label6006 = createLabel(edge,
				AdfgVisualIDRegistry.getType(ChannelIdEditPart.VISUAL_ID));
		...
		Node label6007 = createLabel(edge,
				AdfgVisualIDRegistry.getType(LabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createGraphConnection_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createLossyChannel_4007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		Node label6008 = createLabel(edge,
				AdfgVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
		...
		Node label6009 = createLabel(edge,
				AdfgVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
