...
/**
 * This is the item provider adapter for a {@link adfg.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_initial_feature"),
				 getString("_UI_Channel_initial_description"),
				 AdfgPackage.Literals.CHANNEL__INITIAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Channel_type") + " " + channel.getId();
	}
