...
/**
 * This is the item provider adapter for a {@link adfg.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_size_feature"),
				 getString("_UI_Connection_size_description"),
				 AdfgPackage.Literals.CONNECTION__SIZE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Connection_type") + " " + connection.getId();
	}
