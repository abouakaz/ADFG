...
import adfg.provider.custom.propertydescriptors.TypeItemPropertyDescriptor;
...
/**
 * This is the item provider adapter for a {@link adfg.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_sequence_feature"),
				 getString("_UI_Port_sequence_description"),
				 AdfgPackage.Literals.PORT__SEQUENCE,
				 true,
				 false,
				 false,
				...
				public void setPropertyValue(Object object, Object value){
					...
					v=PortImpl.stringtoSequence(oldValue, v);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_Port_name_description"),
				 AdfgPackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new TypeItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_type_feature"),
				 getString("_UI_Port_type_description"),
				 AdfgPackage.Literals.PORT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
